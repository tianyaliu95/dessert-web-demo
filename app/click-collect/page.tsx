...
export default function ClickCollectPage() {
  return (
    <div className="w-full flex flex-col items-center bg-white py-12 md:py-20 px-4 min-h-screen">
      <h1 className="text-4xl md:text-5xl font-extrabold text-blue-900 mb-8 md:mb-10 text-center uppercase tracking-tight">Click & Collect</h1>
      ...
      <a href="/contact" className="inline-block bg-blue-900 hover:bg-blue-800 text-white font-bold py-3 px-8 rounded-full shadow transition text-lg mt-6">Order cake!</a>
    </div>
  );
} 